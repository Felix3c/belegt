...
- **Regel seit 04.09. (Felix):** Vor jeder Arbeit an belegt zuerst beide Postfächer (hallo@belegbar.eu, Gmail). Grund: zweimal drei Tage Verzug bei Antworten von Requesty (25.→28.08., 02.→04.09.) — ein Widerspruch gegen ein Projekt, das anderen Fristen setzt.
